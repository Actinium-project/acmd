...
func GetBlockWeight(blk *acmutil.Block) int64 {
...
func GetTransactionWeight(tx *acmutil.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *acmutil.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint, bip16, segWit bool) (int, error) {
