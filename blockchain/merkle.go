...
// is the zeroHash.
func BuildMerkleTreeStore(transactions []*acmutil.Tx, witness bool) []*chainhash.Hash {
...
func ExtractWitnessCommitment(tx *acmutil.Tx) ([]byte, bool) {
...
func ValidateWitnessCommitment(blk *acmutil.Block) error {
