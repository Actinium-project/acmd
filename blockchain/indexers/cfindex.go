...
func storeFilter(dbTx database.Tx, block *acmutil.Block, f *gcs.Filter,
...
func (idx *CfIndex) ConnectBlock(dbTx database.Tx, block *acmutil.Block,
...
func (idx *CfIndex) DisconnectBlock(dbTx database.Tx, block *acmutil.Block,
