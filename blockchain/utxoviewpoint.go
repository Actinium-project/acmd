...
func (view *UtxoViewpoint) AddTxOut(tx *acmutil.Tx, txOutIdx uint32, blockHeight int32) {
...
func (view *UtxoViewpoint) AddTxOuts(tx *acmutil.Tx, blockHeight int32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *acmutil.Tx, blockHeight int32, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *acmutil.Block, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(db database.DB, block *acmutil.Block, stxos []SpentTxOut) error {
...
// not modified.
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *acmutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *acmutil.Tx) (*UtxoViewpoint, error) {
