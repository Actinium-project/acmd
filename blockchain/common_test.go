...
// acmutil.Block.  This is largely borrowed from the test code in acmdb.
func loadBlocks(filename string) (blocks []*acmutil.Block, err error) {
	...
	for height := int64(1); err == nil; height++ {
		...
		block, err = acmutil.NewBlockFromBytes(rbytes)
		if err != nil {
			return
		}
