...
func createCoinbaseTx(coinbaseScript []byte, nextBlockHeight int32,
	addr acmutil.Address, mineTo []wire.TxOut,
	net *chaincfg.Params) (*acmutil.Tx, error) {
...
func CreateBlock(prevBlock *acmutil.Block, inclusionTxs []*acmutil.Tx,
	blockVersion int32, blockTime time.Time, miningAddr acmutil.Address,
	mineTo []wire.TxOut, net *chaincfg.Params) (*acmutil.Block, error) {
	...
	blockTxns := []*acmutil.Tx{coinbaseTx}
	if inclusionTxs != nil {
	...
	utilBlock := acmutil.NewBlock(&block)
