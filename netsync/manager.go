...
import (
	...
	peerpkg "github.com/Actinium-project/acmd/peer"
...
func (sm *SyncManager) handleBlockchainNotification(notification *blockchain.Notification) {
	...
	case blockchain.NTBlockAccepted:
		...
		block, ok := notification.Data.(*acmutil.Block)
		if !ok {
...
// processed.
func (sm *SyncManager) QueueTx(tx *acmutil.Tx, peer *peerpkg.Peer, done chan struct{}) {
...
// processed.
func (sm *SyncManager) QueueBlock(block *acmutil.Block, peer *peerpkg.Peer, done chan struct{}) {
...
// chain.
func (sm *SyncManager) ProcessBlock(block *acmutil.Block, flags blockchain.BehaviorFlags) (bool, error) {
