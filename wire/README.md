...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/Actinium-project/acmd/wire)
=======
...
[here](https://blog.conformal.com/btcwire-the-bitcoin-wire-protocol-package-from-acmd/).
...
```bash
$ go get -u github.com/Actinium-project/acmd/wire
```
