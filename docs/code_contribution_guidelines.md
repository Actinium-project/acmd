...
reason, the acmd suite has a formalized and rigorous development process which
...
- [Effective Go](http://golang.org/doc/effective_go.html) - The entire acmd
...
One of the major design goals of all core acmd packages is to aim for complete
...
commits](https://github.com/Actinium-project/acmd/commits/master) for examples of
commit messages.
...
contributions.  This is how to get your changes into acmd.
...
Rejoice as you will now be listed as a [contributor](https://github.com/Actinium-project/acmd/graphs/contributors)!
...
[ISC license](https://github.com/Actinium-project/acmd/blob/master/LICENSE).  This is
the same license as all of the code in the acmd suite.
