...
(http://godoc.org/github.com/Actinium-project/acmd/chaincfg)
...
func main() {
	...
	addr, err := acmutil.NewAddressPubKeyHash(pubKeyHash, chainParams)
	if err != nil {
		log.Fatal(err)
	}
	fmt.Println(addr)
...
```bash
$ go get -u github.com/Actinium-project/acmd/chaincfg
```
