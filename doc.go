...
/*
acmd is a full-node bitcoin implementation written in Go.

The default options are sane for most users.  This means acmd will work 'out of
...
parsed when acmd starts up.  By default, the configuration file is located at
~/.acmd/acmd.conf on POSIX-style operating systems and %LOCALAPPDATA%\acmd\acmd.conf
