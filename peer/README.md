...
(http://godoc.org/github.com/Actinium-project/acmd/peer)
...
```bash
$ go get -u github.com/Actinium-project/acmd/peer
```

## Examples

* [New Outbound Peer Example]
  (https://godoc.org/github.com/Actinium-project/acmd/peer#example-package--NewOutboundPeer)  
