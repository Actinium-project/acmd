...
var helpDescsEnUS = map[string]string{
	...
	"createrawtransaction-amounts--desc":  "The destination address as the key and the amount in ACM as the value",
	...
	"scriptpubkeyresult-addresses": "The actinium addresses associated with this script",

	// Vout help.
	"vout-value":        "The amount in ACM",
	...
	"decodescriptresult-addresses": "The actinium addresses associated with this script",
	...
	"getblock-verbosetx":   "Specifies that each transaction is returned as a JSON object and only applies if the verbose flag is true (acmd extension)",
	...
	"getblockchaininforesult-unifiedsoftforks":     "The status of the super-majority soft-forks used by Actiniumd on or after v0.19.0",
	...
	"unifiedsoftforks-softforks":        "The status of the super-majority soft-forks used by Actiniumd on or after v0.19.0",
	"unifiedsoftforks-softforks--key":   "softforks",
	"unifiedsoftforks-softforks--value": "An object describing an active softfork deployment used by Actiniumd on or after v0.19.0",
	"unifiedsoftforks-softforks--desc":  "JSON object describing an active softfork deployment used by Actiniumd on or after v0.19.0",
	...
	"getcurrentnet--synopsis": "Get actinium network the server is running on.",
	...
	"infochainresult-relayfee":        "The minimum relay fee for non-free transactions in ACM/KB",
	...
	"infowalletresult-balance":         "The total actinium balance of the wallet",
	...
	"infowalletresult-paytxfee":        "The transaction fee set in ACM/KB",
	"infowalletresult-relayfee":        "The minimum relay fee for non-free transactions in ACM/KB",
	...
	"getrawmempoolverboseresult-fee":              "Transaction fee in actiniums",
	...
	"gettxoutresult-value":         "The transaction amount in ACM",
	...
	"sendrawtransaction-allowhighfees": "Whether or not to allow insanely high fees (acmd does not yet implement this parameter, so it has no effect)",
	"sendrawtransaction-maxfeerate":    "Used by Actiniumd on or after v0.19.0",
	...
	// StopCmd help.
	"stop--synopsis": "Shutdown acmd.",
	"stop--result0":  "The string 'acmd stopping.'",
	...
	"validateaddresschainresult-address": "The actinium address (only when isvalid is true)",

	// ValidateAddressCmd help.
	"validateaddress--synopsis": "Verify an address is valid.",
	"validateaddress-address":   "Actinium address to validate",
	...
	"verifymessage-address":   "The actinium address to use for the signature",
	...
	// NotifySpentCmd help.
	"notifyspent--synopsis": "Send a redeemingtx notification when a transaction spending an outpoint appears in mempool (if relayed to this acmd instance) and when such a transaction first appears in a newly-attached block.",
...
var rpcResultTypes = map[string][]interface{}{
	...
	"decoderawtransaction":  {(*acmjson.TxRawDecodeResult)(nil)},
	"decodescript":          {(*acmjson.DecodeScriptResult)(nil)},
	"estimatefee":           {(*float64)(nil)},
	"generate":              {(*[]string)(nil)},
	"getaddednodeinfo":      {(*[]string)(nil), (*[]acmjson.GetAddedNodeInfoResult)(nil)},
	"getbestblock":          {(*acmjson.GetBestBlockResult)(nil)},
	"getbestblockhash":      {(*string)(nil)},
	"getblock":              {(*string)(nil), (*acmjson.GetBlockVerboseResult)(nil)},
	"getblockcount":         {(*int64)(nil)},
	"getblockhash":          {(*string)(nil)},
	"getblockheader":        {(*string)(nil), (*acmjson.GetBlockHeaderVerboseResult)(nil)},
	"getblocktemplate":      {(*acmjson.GetBlockTemplateResult)(nil), (*string)(nil), nil},
	"getblockchaininfo":     {(*acmjson.GetBlockChainInfoResult)(nil)},
	...
	"getinfo":               {(*acmjson.InfoChainResult)(nil)},
	"getmempoolinfo":        {(*acmjson.GetMempoolInfoResult)(nil)},
	"getmininginfo":         {(*acmjson.GetMiningInfoResult)(nil)},
	"getnettotals":          {(*acmjson.GetNetTotalsResult)(nil)},
	"getnetworkhashps":      {(*int64)(nil)},
	"getpeerinfo":           {(*[]acmjson.GetPeerInfoResult)(nil)},
	"getrawmempool":         {(*[]string)(nil), (*acmjson.GetRawMempoolVerboseResult)(nil)},
	"getrawtransaction":     {(*string)(nil), (*acmjson.TxRawResult)(nil)},
	"gettxout":              {(*acmjson.GetTxOutResult)(nil)},
	"node":                  nil,
	"help":                  {(*string)(nil), (*string)(nil)},
	"ping":                  nil,
	"searchrawtransactions": {(*string)(nil), (*[]acmjson.SearchRawTransactionsResult)(nil)},
	"sendrawtransaction":    {(*string)(nil)},
	"setgenerate":           nil,
	"stop":                  {(*string)(nil)},
	"submitblock":           {nil, (*string)(nil)},
	"uptime":                {(*int64)(nil)},
	"validateaddress":       {(*acmjson.ValidateAddressChainResult)(nil)},
	"verifychain":           {(*bool)(nil)},
	"verifymessage":         {(*bool)(nil)},
	"version":               {(*map[string]acmjson.VersionResult)(nil)},

	// Websocket commands.
	"loadtxfilter":              nil,
	"session":                   {(*acmjson.SessionResult)(nil)},
	"notifyblocks":              nil,
	...
	"stopnotifyspent":           nil,
	"rescan":                    nil,
	"rescanblocks":              {(*[]acmjson.RescannedBlock)(nil)},
}
...
func (c *helpCacher) rpcMethodHelp(method string) (string, error) {
	...
	help, err := acmjson.GenerateHelp(method, helpDescsEnUS, resultTypes...)
	if err != nil {
		return "", err
	}
...
func (c *helpCacher) rpcUsage(includeWebsockets bool) (string, error) {
	...
	for k := range rpcHandlers {
		usage, err := acmjson.MethodUsageText(k)
		if err != nil {
			return "", err
		}
