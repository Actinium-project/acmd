...
var (
	...
	defaultDataDir  = filepath.Join(acmdHomeDir, "data")
...
type config struct {
	DataDir        string `short:"b" long:"datadir" description:"Location of the acmd data directory"`
...
// time of writing, acmd currently places blocks for testnet version 3 in the
