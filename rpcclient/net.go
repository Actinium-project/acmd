...
func (c *Client) NodeAsync(command acmjson.NodeSubCmd, host string,
	connectSubCmd *string) FutureNodeResult {
	cmd := acmjson.NewNodeCmd(command, host, connectSubCmd)
	return c.sendCmd(cmd)
}
...
func (c *Client) Node(command acmjson.NodeSubCmd, host string,
