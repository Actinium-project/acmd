...
func TestChainSvrWsNtfns(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name: "blockconnected",
			newNtfn: func() (interface{}, error) {
				return acmjson.NewCmd("blockconnected", "123", 100000, 123456789)
			},
			staticNtfn: func() interface{} {
				return acmjson.NewBlockConnectedNtfn("123", 100000, 123456789)
			},
		...
		},
		{
			...
			newNtfn: func() (interface{}, error) {
				return acmjson.NewCmd("blockdisconnected", "123", 100000, 123456789)
			},
			staticNtfn: func() interface{} {
				return acmjson.NewBlockDisconnectedNtfn("123", 100000, 123456789)
			},
		...
		},
		{
			...
			newNtfn: func() (interface{}, error) {
				return acmjson.NewCmd("filteredblockconnected", 100000, "header", []string{"tx0", "tx1"})
			},
			staticNtfn: func() interface{} {
				return acmjson.NewFilteredBlockConnectedNtfn(100000, "header", []string{"tx0", "tx1"})
			},
			marshalled: `{"jsonrpc":"1.0","method":"filteredblockconnected","params":[100000,"header",["tx0","tx1"]],"id":null}`,
			unmarshalled: &acmjson.FilteredBlockConnectedNtfn{
				Height:        100000,
				Header:        "header",
		...
		},
		{
			...
			newNtfn: func() (interface{}, error) {
				return acmjson.NewCmd("filteredblockdisconnected", 100000, "header")
			},
			staticNtfn: func() interface{} {
				return acmjson.NewFilteredBlockDisconnectedNtfn(100000, "header")
			},
			marshalled: `{"jsonrpc":"1.0","method":"filteredblockdisconnected","params":[100000,"header"],"id":null}`,
			unmarshalled: &acmjson.FilteredBlockDisconnectedNtfn{
				Height: 100000,
				Header: "header",
			},
		},
		{
			name: "recvtx",
			newNtfn: func() (interface{}, error) {
				return acmjson.NewCmd("recvtx", "001122", `{"height":100000,"hash":"123","index":0,"time":12345678}`)
			},
			staticNtfn: func() interface{} {
				...
				return acmjson.NewRecvTxNtfn("001122", &blockDetails)
			},
		...
		},
		{
			name: "redeemingtx",
			newNtfn: func() (interface{}, error) {
				return acmjson.NewCmd("redeemingtx", "001122", `{"height":100000,"hash":"123","index":0,"time":12345678}`)
			},
			staticNtfn: func() interface{} {
				blockDetails := acmjson.BlockDetails{
					Height: 100000,
				...
				return acmjson.NewRedeemingTxNtfn("001122", &blockDetails)
			},
		...
		},
		{
			name: "rescanfinished",
			newNtfn: func() (interface{}, error) {
				return acmjson.NewCmd("rescanfinished", "123", 100000, 12345678)
			},
			staticNtfn: func() interface{} {
				return acmjson.NewRescanFinishedNtfn("123", 100000, 12345678)
			},
		...
		},
		{
			name: "rescanprogress",
			newNtfn: func() (interface{}, error) {
				return acmjson.NewCmd("rescanprogress", "123", 100000, 12345678)
			},
			staticNtfn: func() interface{} {
				return acmjson.NewRescanProgressNtfn("123", 100000, 12345678)
			},
		...
		},
		{
			name: "txaccepted",
			newNtfn: func() (interface{}, error) {
				return acmjson.NewCmd("txaccepted", "123", 1.5)
			},
			staticNtfn: func() interface{} {
		...
		},
		{
			...
			newNtfn: func() (interface{}, error) {
				return acmjson.NewCmd("txacceptedverbose", `{"hex":"001122","txid":"123","version":1,"locktime":4294967295,"vin":null,"vout":null,"confirmations":0}`)
			},
			staticNtfn: func() interface{} {
				txResult := acmjson.TxRawResult{
					Hex:           "001122",
					Txid:          "123",
					Version:       1,
					LockTime:      4294967295,
				...
				return acmjson.NewTxAcceptedVerboseNtfn(txResult)
			},
		...
		},
		{
			...
			newNtfn: func() (interface{}, error) {
				return acmjson.NewCmd("relevanttxaccepted", "001122")
			},
			staticNtfn: func() interface{} {
				return acmjson.NewRelevantTxAcceptedNtfn("001122")
			},
	...
	for i, test := range tests {
		...
		marshalled, err := acmjson.MarshalCmd(nil, test.staticNtfn())
		if err != nil {
		...
		// notifications.
		marshalled, err = acmjson.MarshalCmd(nil, cmd)
		if err != nil {
			t.Errorf("MarshalCmd #%d (%s) unexpected error: %v", i,
				test.name, err)
			continue
